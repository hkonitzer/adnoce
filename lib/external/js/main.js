...
var LogView = Backbone.View.extend({
  ...
  render : function(model) {
    ...
    // add type element
    var typeDiv = $('<div>', {'class' : 'loglinecontent adnocetype'});
    loglinediv.append(typeDiv);
    switch(model.get('adnocetype')) {
        // generic event
      case 200:
        loglinediv.append('<div class="loglinecontent eventname" title="'+model.get('adnocetype')+'">'+model.get('eventname')+'</div>');
        typeDiv.text('E');   
        break;
      default: // a view
